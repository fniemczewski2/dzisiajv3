...
const CalendarCell: React.FC<Props> = ({ date, currentMonth, tCount, eCount, isMobile, onClick }) => {
  ...
  return (
    <div
      className={clsx(
        "bg-card p-1 flex flex-col justify-between shadow hover:bg-gray-100p-1 sm:min-h-[106px] min-h-[86px] rounded-md m-0.25 hover:bg-gray-100 cursor-pointer overflow-hidden",
